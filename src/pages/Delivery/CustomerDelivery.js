...
import { customerDeliveries as initialDeliveries } from '../../data/mockData';
  ...
  return (
    <Box>
      ...
      <Card mb={6}>
        <CardBody>
          <HStack spacing={4} mb={4} flexWrap="wrap">
            <Input
              placeholder="Search by delivery no, order no, customer..."
              value={searchTerm}
      ...
      <Modal isOpen={isViewOpen} onClose={onViewClose} size="xl">
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Customer Delivery Details</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            {selectedDelivery && (
              <VStack align="stretch" spacing={4}>
                ...
                <Box>
                  <Text fontSize="sm" color="gray.600" mb={2}>Delivery Route</Text>
                  <HStack spacing={2} align="center">
                    <Badge colorScheme="orange">{selectedDelivery.fromLocation}</Badge>
                    <FiMapPin />
                    <Text fontSize="sm">→</Text>
                    <Badge colorScheme="green">Customer Address</Badge>
                  </HStack>
                  <Text fontSize="sm" mt={2}><strong>To:</strong> {selectedDelivery.toAddress}</Text>
                </Box>
                ...
                <Box>
                  <Text fontSize="sm" color="gray.600" mb={2}>Items</Text>
                ...
                <SimpleGrid columns={2} spacing={4}>
                  ...
                  <Box>
                    ...
                    <Text fontWeight="600">{formatDateTime(selectedDelivery.deliveredTime)}</Text>
                  </Box>
